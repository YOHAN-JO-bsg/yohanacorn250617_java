...
public class MainClass09 {
	public static void main(String[] args) {
		...
		// Set 객체에 저장된 모든 아이템의 순서를 보장할 수는 없지만 모두 참조해서 사용해 보기
		set1.forEach((item)->{;
		...
		// Iterator 를 사용하는 구조도 연습해 보자 (Set 의 Generic 이 Iteraor 의 Generic 이 된다)
		 Iterator<String> it= set2.iterator();
		 /*
		  *  무한 루프를 구성하거나 정확한 반복 횟수를 알 수 없을 때 while(){} 문을 많이 사용한다.
		  */
