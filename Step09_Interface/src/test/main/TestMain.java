...
public class TestMain { // 클래스의 범위를 나타내는 중괄호 "시작"
	/*
	 * 클래스안에 무언가를 정의할 때는 클래스 안에 속해 있다는 의미에서 들여 쓰기를 한다.
	 * 클래스 안에 정의할 수 있는 것은
	 * 1. 필드, static 필드
	 * 2. 메소드, static 메소드
	 * 3. 생성자
	...
	public TestMain() {
		// 여기는 생성자 내부
		// 어디에선가 new TestMain() 에서 객체를 생성하면 여기가 실행된다.
		System.out.println("TestMain 생성자가 호출 됨");
		// 생성자 안에도 지역변수를 만들 수 있다.
	}
	...
	public static void doSomething() {
		// 어디에선가 클래스명에 . 찍어서 호출하는 메소드 TestMain.doSomething() 으로 호출할 수 있다.
		System.out.println("doSomething() 메소드 호출 됨");
	}
