...
public class MainClass06 {
	public static void main(String[] args) {
		 ...
		 *  - 필요 없다. 따라서 클래스의 이름을 짓기도 졸라 귀찮음 => 익명의 Local Inner Class 를 활용
		 *  -  
		 */
		 ...
		 *  익명의 Local Inner Class 를 이용해서 Weapon 객체를 생성해서 공격할 예정인데,
		 *  1번만 공격할거야 => 위에처럼 w1 이라는 변수를 만들지 않고 1회용으로 객체를 만들어서 사용할 예정
		 */
